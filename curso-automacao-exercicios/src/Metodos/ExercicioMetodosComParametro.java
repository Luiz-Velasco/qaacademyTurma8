...
public class ExercicioMetodosComParametro {
    ...
    public static void main(String[] args) {
        // Com retorno
        System.out.println(exibirNomeEIdade(33, "Luiz")); 
        System.out.println(retornarPalavra("Teste")); 
        System.out.println(retornarDobro(10));
        System.out.println(retornarNomeSobrenome("Luiz", "Velasco"));
        System.out.println(retornarSalario("Luiz"));
        
        //Sem Retorno
        exibirNomeEIdadeSemRetorno(30, "Luiz");
        retornarPalavraSemRetorno("Teste");
        retornarDobroSemRetorno(10);
        retornarNomeSobrenomeSemRetorno("Luiz", "Velascos");
        retornarSalarioSemRetorno("Luiz");
